                        ...
                        <nav className="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
                            <ul className="nav nav-pills flex-column">
                                <li className="nav-item">
                                    <a className="nav-link active">Overview <span
                            ...
                            <ul className="nav nav-pills flex-column">
                                <li className="nav-item">
                                    <a className="nav-link">Nav item</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link">Nav item again</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link">One more nav</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link">Another nav item</a>
                                </li>
                            </ul>
